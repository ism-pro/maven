...
public class MailaddressController implements Serializable {
    ...
    protected void initialize() {
        ...
        // STRING PARSE
        String src_01 = "MailaddressField_";
        String src_02 = "MailaddressField_";
        String src_03 = "MailaddressField_";
        String src_04 = "MailaddressField_";
        String src_05 = "MailaddressField_";
        String src_06 = "MailaddressField_";
        String src_07 = "MailaddressField_";
        String src_08 = "MailaddressField_";
        String src_09 = "MailaddressField_";
        String src_10 = "MailaddressField_";
        String src_11 = "MailaddressField_";
        String src_12 = "MailaddressField_";
        String src_13 = "MailaddressField_";
        String src_14 = "MailaddressField_";
        String src_15 = "MailaddressField_";
        String src_16 = "MailaddressField_";
        String src_17 = "MailaddressField_";
        String src_18 = "MailaddressField_";
        String src_19 = "MailaddressField_";
        String src_20 = "MailaddressField_";
    ...
    public static class MailaddressControllerConverter implements Converter {
        ...
        public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
            ...
            MailaddressController controller = (MailaddressController) facesContext.getApplication().getELResolver().
                    getValue(facesContext.getELContext(), null, "mailaddressController");
            return controller.getMailaddress(getKey(value));
        }
    ...
    //
    // /////////////////////////////////////////////////////////////////////////
    @FacesValidator(value = "Mailaddress_MailaddressValidator")
    public static class Mailaddress_MailaddressValidator implements Validator {

        public static final String P_DUPLICATION_CODE_SUMMARY_ID = "MailaddressDuplicationSummary_####";
        public static final String P_DUPLICATION_CODE_DETAIL_ID = "MailaddressDuplicationDetail_###";
        ...
        public void validate(FacesContext fc, UIComponent uic, Object o) throws ValidatorException {
            ...
            List<Mailaddress> lst = ejbFacade.findByCode(value);
            if (lst != null) {
    ...
    @FacesValidator(value = "Mailaddress_DesignationValidator")
    public static class MailaddressDesignationValidator implements Validator {

        public static final String P_DUPLICATION_DESIGNATION_SUMMARY_ID = "MailaddressDuplicationSummary_#####";
        public static final String P_DUPLICATION_DESIGNATION_DETAIL_ID = "MailaddressDuplicationDetail_#####";
        ...
        public void validate(FacesContext fc, UIComponent uic, Object o) throws ValidatorException {
            ...
            InputText input = (InputText) uic;
            List<Mailaddress> lst = ejbFacade.findByDesignation(value);
            if (lst != null) {
                if (input.getValue() != null) {
                    if (value.matches((String) input.getValue())) {
                        return;

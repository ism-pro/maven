...
public class IsmRoleController implements Serializable {
    ...
    @EJB
    private org.ism.sessions.IsmRoleFacade ejbFacade;
    ...
    public static class IsmRoleControllerConverter implements Converter {
        ...
        public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
            ...
            IsmRoleController controller = (IsmRoleController) facesContext.getApplication().getELResolver().
                    getValue(facesContext.getELContext(), null, "ismRoleController");
            return controller.getIsmRole(getKey(value));
        }

...
import org.ism.sessions.IsmNcrstateFacade;
...
@Named("ismNcrstateController")
@SessionScoped
public class IsmNcrstateController implements Serializable {
    private static final long serialVersionUID = 1L;

    @EJB
    private org.ism.sessions.IsmNcrstateFacade ejbFacade;
    ...
    public static class IsmNcrstateControllerConverter implements Converter {
        ...
        public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
            ...
            IsmNcrstateController controller = (IsmNcrstateController) facesContext.getApplication().getELResolver().
                    getValue(facesContext.getELContext(), null, "ismNcrstateController");
            return controller.getIsmNcrstate(getKey(value));
        }

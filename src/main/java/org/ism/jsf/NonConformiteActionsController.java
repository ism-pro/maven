...
import org.ism.sessions.NonConformiteActionsFacade;
...
public class NonConformiteActionsController implements Serializable {
    ...
    public static class NonConformiteActionsControllerConverter implements Converter {
        ...
        public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
            ...
            NonConformiteActionsController controller = (NonConformiteActionsController) facesContext.getApplication().getELResolver().
                    getValue(facesContext.getELContext(), null, "nonConformiteActionsController");
            return controller.getNonConformiteActions(getKey(value));
        }
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof NonConformiteActions) {
                NonConformiteActions o = (NonConformiteActions) object;
                return getStringKey(o.getNcaId());
            } else {
                Logger.getLogger(this.getClass().getName()).log(Level.SEVERE, "object {0} is of type {1}; expected type: {2}", new Object[]{object, object.getClass().getName(), NonConformiteActions.class.getName()});
                return null;
            }
        }
    ...
    @FacesValidator(value = "NonConformiteActionsCodeValidator")
    public static class NonConformiteActionsCodeValidator implements Validator {

        public static final String P_DUPLICATION_CODE_SUMMARY_ID = "NonConformiteActionsDuplicationField_codeSummary";
        public static final String P_DUPLICATION_CODE_DETAIL_ID = "NonConformiteActionsDuplicationField_codeDetail";
        ...
        public void validate(FacesContext fc, UIComponent uic, Object o) throws ValidatorException {
            ...
            List<NonConformiteActions> lst = ejbFacade.findByCode(value);
            if (lst != null) {
    ...
    @FacesValidator(value = "NonConformiteActionsDesignationValidator")
    public static class NonConformiteActionsDesignationValidator implements Validator {

        public static final String P_DUPLICATION_DESIGNATION_SUMMARY_ID = "NonConformiteActionsDuplicationField_designationSummary";
        public static final String P_DUPLICATION_DESIGNATION_DETAIL_ID = "NonConformiteActionsDuplicationField_designationDetail";
        ...
        public void validate(FacesContext fc, UIComponent uic, Object o) throws ValidatorException {
            ...
            InputText input = (InputText) uic;
            List<NonConformiteActions> lst = ejbFacade.findByDesignation(value);
            if (lst != null) {
                if (input.getValue() != null) {
                    if (value.matches((String) input.getValue())) {
                        return;

...
public class PointInfosController implements Serializable {
    ...
    public static class PointInfosControllerConverter implements Converter {
        ...
        public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
            ...
            PointInfosController controller = (PointInfosController) facesContext.getApplication().getELResolver().
                    getValue(facesContext.getELContext(), null, "pointInfosController");
            return controller.getPointInfos(getKey(value));
        }
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof PointInfos) {
                PointInfos o = (PointInfos) object;
                return getStringKey(o.getPiId());
            } else {
                Logger.getLogger(this.getClass().getName()).log(Level.SEVERE, "object {0} is of type {1}; expected type: {2}", new Object[]{object, object.getClass().getName(), PointInfos.class.getName()});
                return null;
            }
        }
    ...
    ///
    ////////////////////////////////////////////////////////////////////////////
    @FacesValidator(value = "PointInfos_PointInfosValidator")
    public static class PointInfos_PointInfosValidator implements Validator {

        public static final String P_DUPLICATION_CODE_SUMMARY_ID = "PointInfosDuplicationSummary_####";
        public static final String P_DUPLICATION_CODE_DETAIL_ID = "PointInfosDuplicationDetail_###";
        ...
        public void validate(FacesContext fc, UIComponent uic, Object o) throws ValidatorException {
            ...
            List<PointInfos> lst = ejbFacade.findByCode(value);
            if (lst != null) {
    ...
    @FacesValidator(value = "PointInfos_DesignationValidator")
    public static class PointInfosDesignationValidator implements Validator {

        public static final String P_DUPLICATION_DESIGNATION_SUMMARY_ID = "PointInfosDuplicationSummary_#####";
        public static final String P_DUPLICATION_DESIGNATION_DETAIL_ID = "PointInfosDuplicationDetail_#####";
        ...
        public void validate(FacesContext fc, UIComponent uic, Object o) throws ValidatorException {
            ...
            InputText input = (InputText) uic;
            List<PointInfos> lst = ejbFacade.findByDesignation(value);
            if (lst != null) {
                if (input.getValue() != null) {
                    if (value.matches((String) input.getValue())) {
                        return;

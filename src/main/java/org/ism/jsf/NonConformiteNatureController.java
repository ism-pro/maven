...
import org.ism.sessions.NonConformiteNatureFacade;
...
public class NonConformiteNatureController implements Serializable {
    ...
    @EJB
    private org.ism.sessions.NonConformiteNatureFacade ejbFacade;
    ...
    public static class NonConformiteNatureControllerConverter implements Converter {
        ...
        public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
            ...
            NonConformiteNatureController controller = (NonConformiteNatureController) facesContext.getApplication().getELResolver().
                    getValue(facesContext.getELContext(), null, "nonConformiteNatureController");
            return controller.getNonConformiteNature(getKey(value));
        }
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof NonConformiteNature) {
                NonConformiteNature o = (NonConformiteNature) object;
                return getStringKey(o.getNcnId());
            } else {
                Logger.getLogger(this.getClass().getName()).log(Level.SEVERE, "object {0} is of type {1}; expected type: {2}", new Object[]{object, object.getClass().getName(), NonConformiteNature.class.getName()});
                return null;
            }
        }
    ...
    @FacesValidator(value = "NonConformiteNatureCodeValidator")
    public static class NonConformiteNatureCodeValidator implements Validator {

        public static final String P_DUPLICATION_CODE_SUMMARY_ID = "NonConformiteNatureDuplicationField_codeSummary";
        public static final String P_DUPLICATION_CODE_DETAIL_ID = "NonConformiteNatureDuplicationField_codeDetail";
        ...
        public void validate(FacesContext fc, UIComponent uic, Object o) throws ValidatorException {
            ...
            List<NonConformiteNature> lst = ejbFacade.findByCode(value);
            if (lst != null) {

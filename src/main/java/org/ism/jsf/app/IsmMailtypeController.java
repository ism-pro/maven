...
//        selected.setIsmChanged(new Date());
    ...
    public static class IsmMailtypeControllerConverter implements Converter {
        ...
        public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
            ...
            IsmMailtypeController controller = (IsmMailtypeController) facesContext.getApplication().getELResolver().
                    getValue(facesContext.getELContext(), null, "ismMailtypeController");
            return controller.getIsmMailtype(getKey(value));
        }
    ...
    //
    // /////////////////////////////////////////////////////////////////////////
    @FacesValidator(value = "IsmMailtype_IsmMailtypeValidator")
    public static class IsmMailtype_IsmMailtypeValidator implements Validator {

        public static final String P_DUPLICATION_CODE_SUMMARY_ID = "IsmMailtypeDuplicationSummary_####";
        public static final String P_DUPLICATION_CODE_DETAIL_ID = "IsmMailtypeDuplicationDetail_###";
        ...
        public void validate(FacesContext fc, UIComponent uic, Object o) throws ValidatorException {
            ...
            List<IsmMailtype> lst = ejbFacade.findByCode(value);
            if (lst != null) {
    ...
    @FacesValidator(value = "IsmMailtype_DesignationValidator")
    public static class IsmMailtypeDesignationValidator implements Validator {

        public static final String P_DUPLICATION_DESIGNATION_SUMMARY_ID = "IsmMailtypeDuplicationSummary_#####";
        public static final String P_DUPLICATION_DESIGNATION_DETAIL_ID = "IsmMailtypeDuplicationDetail_#####";
        ...
        public void validate(FacesContext fc, UIComponent uic, Object o) throws ValidatorException {
            ...
            InputText input = (InputText) uic;
            List<IsmMailtype> lst = ejbFacade.findByDesignation(value);
            if (lst != null) {
                if (input.getValue() != null) {
                    if (value.matches((String) input.getValue())) {
                        return;

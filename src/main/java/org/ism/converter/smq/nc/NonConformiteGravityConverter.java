...
@ManagedBean
@SessionScoped
@FacesConverter(value = "nonConformiteGravityConverter")
public class NonConformiteGravityConverter implements Converter, Serializable {
    ...
    public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
        ...
        try {
            ...
            JsfUtil.out("NonConformiteGravityConverter :  Impossible de convertir la valeur " + value + " en entier ! Erreur : " + ex.getLocalizedMessage());
            return null;
        }

        return nonConformiteGravityController.getNonConformiteGravity(getKey(value));
    }

...
@ManagedBean
@SessionScoped
@FacesConverter(value = "nonConformiteFrequencyConverter")
public class NonConformiteFrequencyConverter implements Converter, Serializable {
    ...
    public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
        ...
        try {
            ...
            JsfUtil.out("NonConformiteFrequencyConverter :  Impossible de convertir la valeur " + value + " en entier ! Erreur : " + ex.getLocalizedMessage());
            return null;
        }

        return nonConformiteFrequencyController.getNonConformiteFrequency(getKey(value));
    }

...
@ManagedBean
@SessionScoped
@FacesConverter(value = "nonConformiteRequestConverter")
public class NonConformiteRequestConverter implements Converter, Serializable {
    ...
    public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
        ...
        try {
            ...
            JsfUtil.out("NonConformiteRequestConverter :  Impossible de convertir la valeur " + value + " en entier ! Erreur : " + ex.getLocalizedMessage());
            return null;
        }

        return nonConformiteRequestController.getNonConformiteRequest(getKey(value));
    }

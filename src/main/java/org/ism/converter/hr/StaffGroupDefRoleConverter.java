...
@ManagedBean
@SessionScoped
@FacesConverter(value = "staffGroupDefRoleConverter")
public class StaffGroupDefRoleConverter implements Converter, Serializable {
    ...
    public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
        ...
        try {
            ...
            JsfUtil.out("StaffGroupDefRoleConverter :  Impossible de convertir la valeur " + value + " en entier ! Erreur : " + ex.getLocalizedMessage());
            return null;
        }

        return staffGroupDefRoleController.getStaffGroupDefRole(getKey(value));
    }

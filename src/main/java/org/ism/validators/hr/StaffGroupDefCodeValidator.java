...
public class StaffGroupDefCodeValidator implements Validator , Serializable {
    ...
    public void validate(FacesContext fc, UIComponent uic, Object o) throws ValidatorException {
        ...
        List<StaffGroupDef> lst = staffGroupDefController.getItemsByCode(value, staffAuthController.getCompany());

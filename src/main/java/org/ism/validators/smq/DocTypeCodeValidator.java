...
@ManagedBean
@SessionScoped
@FacesValidator("docTypeCodeValidator")
public class DocTypeCodeValidator implements Validator, Serializable {
    ...
    public void validate(FacesContext fc, UIComponent uic, Object o) throws ValidatorException {
        ...
        List<DocType> lst = docTypeController.getItemsByCode(value, staffAuthController.getCompany());

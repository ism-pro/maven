...
public class NonConformiteFrequencyDesignationValidator implements Validator, Serializable {
    ...
    public void validate(FacesContext fc, UIComponent uic, Object o) throws ValidatorException {
        ...
        List<NonConformiteFrequency> lst = nonConformiteFrequencyController.getItemsByDesignation(value, staffAuthController.getCompany());

...
public class NonConformiteNatureDesignationValidator implements Validator, Serializable {
    ...
    public void validate(FacesContext fc, UIComponent uic, Object o) throws ValidatorException {
        ...
        List<NonConformiteNature> lst = nonConformiteNatureController.getItemsByDesignation(value, staffAuthController.getCompany());

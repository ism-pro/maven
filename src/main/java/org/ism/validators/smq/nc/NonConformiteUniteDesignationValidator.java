...
public class NonConformiteUniteDesignationValidator implements Validator, Serializable {
    ...
    public void validate(FacesContext fc, UIComponent uic, Object o) throws ValidatorException {
        ...
        List<NonConformiteUnite> lst = nonConformiteUniteController.getItemsByDesignation(value, staffAuthController.getCompany());

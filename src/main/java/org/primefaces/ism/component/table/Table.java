...
import org.primefaces.ism.component.table.feature.*;
...
public class Table extends UIData implements org.primefaces.component.api.Widget, org.primefaces.component.api.RTLAware, javax.faces.component.behavior.ClientBehaviorHolder {

    public static final String COMPONENT_TYPE = "org.primefaces.ism.component.Table";
    public static final String COMPONENT_FAMILY = "org.primefaces.ism.component";
    private static final String DEFAULT_RENDERER = "org.primefaces.ism.component.TableRenderer";

    protected enum PropertyKeys {

        widgetVar, scrollable, scrollHeight, scrollWidth, selectionMode, selection, emptyMessage, style, styleClass, liveScroll, rowStyleClass, onExpandStart, resizableColumns, sortBy, sortOrder, sortFunction, scrollRows, rowKey, filterEvent, filterDelay, tableStyle, tableStyleClass, draggableColumns, editable, filteredValue, sortMode, editMode, editingRow, cellSeparator, summary, frozenRows, dir, liveResize, stickyHeader, expandedRow, disabledSelection, rowSelectMode, rowExpandMode, dataLocale, nativeElements, frozenColumns, draggableRows, caseSensitiveSort, skipChildren, disabledTextSelection, sortField, sortedValue, initMode, nullSortOrder, tabindex, reflow, liveScrollBuffer, rowHover, resizeMode;
    ...
    public java.util.List getSortedValue() {
        return (java.util.List) getStateHelper().eval(PropertyKeys.sortedValue, null);
    }

    public void setSortedValue(java.util.List sortedValue) {
        getStateHelper().put(PropertyKeys.sortedValue, sortedValue);
    }
    ...
    private static final String SB_GET_SELECTED_ROW_KEYS_AS_STRING = Table.class.getName() + "#getSelectedRowKeysAsString";
    ...
    public boolean shouldEncodeFeature(FacesContext context) {
        boolean encode_request = context.getExternalContext().getRequestParameterMap().containsKey(this.getClientId(context) + "_encodeFeature");
        if (!encode_request) {
            if (this.getSortedValue() != null && !this.getSortedValue().isEmpty()) {
                return true;
            }
        }

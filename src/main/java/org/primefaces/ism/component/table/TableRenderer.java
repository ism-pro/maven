 ...
 */
package org.primefaces.ism.component.table;
...
import org.primefaces.ism.component.table.feature.DataTableFeature;
import org.primefaces.ism.component.table.feature.DataTableFeatureKey;
import org.primefaces.ism.component.table.feature.RowExpandFeature;
import org.primefaces.ism.component.table.feature.SortFeature;
...
public class TableRenderer extends DataRenderer {
    ...
    private final static Logger logger = Logger.getLogger(TableRenderer.class.getName());
    ...
    protected void preRender(FacesContext context, Table table) {
        if (table.isLazy()) {
    ...
    protected void encodeScript(FacesContext context, Table table) throws IOException {
    ...
    protected void encodeMarkup(FacesContext context, Table table) throws IOException {
        ...
        //style class
        String containerClass = scrollable ? Table.CONTAINER_CLASS + " " + Table.SCROLLABLE_CONTAINER_CLASS : Table.CONTAINER_CLASS;
        containerClass = table.getStyleClass() != null ? containerClass + " " + table.getStyleClass() : containerClass;
        if (table.isResizableColumns()) {
            containerClass = containerClass + " " + Table.RESIZABLE_CONTAINER_CLASS;
        }
        if (table.isStickyHeader()) {
            containerClass = containerClass + " " + Table.STICKY_HEADER_CLASS;
        }
        if (ComponentUtils.isRTL(context, table)) {
            containerClass = containerClass + " " + Table.RTL_CLASS;
        }
        if (table.isReflow()) {
            containerClass = containerClass + " " + Table.REFLOW_CLASS;
        }
        if (hasFrozenColumns) {
        ...
        encodeFacet(context, table, table.getHeader(), Table.HEADER_CLASS);
        ...
        encodeFacet(context, table, table.getFooter(), Table.FOOTER_CLASS);
    ...
    protected void encodeRegularTable(FacesContext context, Table table) throws IOException {
        ResponseWriter writer = context.getResponseWriter();

        writer.startElement("div", null);
        writer.writeAttribute("class", Table.TABLE_WRAPPER_CLASS, null);
        ...
        if (table.getSummary() != null) {
            writer.writeAttribute("summary", table.getSummary(), null);
        }
    ...
    protected void encodeScrollableTable(FacesContext context, Table table) throws IOException {
        ...
        if (hasFrozenColumns) {
            ...
            encodeScrollAreaStart(context, table, Table.SCROLLABLE_HEADER_CLASS, Table.SCROLLABLE_HEADER_BOX_CLASS, tableStyle, tableStyleClass);
            ...
            encodeScrollAreaStart(context, table, Table.SCROLLABLE_FOOTER_CLASS, Table.SCROLLABLE_FOOTER_BOX_CLASS, tableStyle, tableStyleClass);
    ...
    protected void encodeFrozenScrollableTable(FacesContext context, Table table, int frozenColumns) throws IOException {

    }

    protected void encodeScrollAreaStart(FacesContext context, Table table, String containerClass, String containerBoxClass,
    ...
    protected void encodeScrollBody(FacesContext context, Table table, String tableStyle, String tableStyleClass, int columnStart, int columnEnd, String tbodyId) throws IOException {
        ResponseWriter writer = context.getResponseWriter();
        String scrollHeight = table.getScrollHeight();

        writer.startElement("div", null);
        writer.writeAttribute("class", Table.SCROLLABLE_BODY_CLASS, null);
    ...
    public void encodeColumnHeader(FacesContext context, Table table, UIColumn column) throws IOException {
        ...
        String columnClass = sortable ? Table.COLUMN_HEADER_CLASS + " " + Table.SORTABLE_COLUMN_CLASS : Table.COLUMN_HEADER_CLASS;
        columnClass = filterable ? columnClass + " " + Table.FILTER_COLUMN_CLASS : columnClass;
        columnClass = selectionMode != null ? columnClass + " " + Table.SELECTION_COLUMN_CLASS : columnClass;
        columnClass = resizable ? columnClass + " " + Table.RESIZABLE_COLUMN_CLASS : columnClass;
        columnClass = !column.isToggleable() ? columnClass + " " + Table.STATIC_COLUMN_CLASS : columnClass;
        columnClass = !column.isVisible() ? columnClass + " " + Table.HIDDEN_COLUMN_CLASS : columnClass;
        ...
        if (sortable) {
            ...
            if (sortIcon == null) {
                sortIcon = Table.SORTABLE_COLUMN_ICON_CLASS;
            } else {
    ...
    protected String resolveDefaultSortIcon(UIColumn column, SortMeta sortMeta) {
        ...
        if (column.getColumnKey().equals(sortMeta.getColumn().getColumnKey())) {
            if (sortOrder.equals(SortOrder.ASCENDING)) {
                sortIcon = Table.SORTABLE_COLUMN_ASCENDING_ICON_CLASS;
            } else if (sortOrder.equals(SortOrder.DESCENDING)) {
                sortIcon = Table.SORTABLE_COLUMN_DESCENDING_ICON_CLASS;
            }
        }
    ...
    protected String resolveDefaultSortIcon(Table table, UIColumn column, String sortOrder) {
        ValueExpression tableSortByVE = table.getValueExpression("sortBy");
        ValueExpression columnSortByVE = column.getValueExpression("sortBy");
    ...
    protected void encodeColumnHeaderContent(FacesContext context, UIColumn column, String sortIcon) throws IOException {
        ...
        writer.writeAttribute("class", Table.COLUMN_TITLE_CLASS, null);
    ...
    protected void encodeFilter(FacesContext context, Table table, UIColumn column) throws IOException {
        ...
        if (filterFacet == null) {
            ...
            if (table.isReset()) {
                filterValue = "";
            } else if (params.containsKey(filterId)) {
            ...
            if (column.getValueExpression("filterOptions") == null) {
                filterStyleClass = filterStyleClass == null ? Table.COLUMN_INPUT_FILTER_CLASS : Table.COLUMN_INPUT_FILTER_CLASS + " " + filterStyleClass;
                ...
                filterStyleClass = filterStyleClass == null ? Table.COLUMN_FILTER_CLASS : Table.COLUMN_FILTER_CLASS + " " + filterStyleClass;
            ...
            writer.startElement("div", null);
            writer.writeAttribute("class", Table.COLUMN_CUSTOM_FILTER_CLASS, null);
    ...
    public void encodeColumnFooter(FacesContext context, Table table, UIColumn column) throws IOException {
        if (!column.isRendered()) {
            return;
        }
        ...
        styleClass = styleClass == null ? Table.COLUMN_FOOTER_CLASS : Table.COLUMN_FOOTER_CLASS + " " + styleClass;

        if (!column.isVisible()) {
            styleClass = styleClass + " " + Table.HIDDEN_COLUMN_CLASS;
        }
    ...
    protected void encodeThead(FacesContext context, Table table) throws IOException {
        this.encodeThead(context, table, 0, table.getColumns().size(), null, null);
    }

    protected void encodeThead(FacesContext context, Table table, int columnStart, int columnEnd, String theadId, String columnGroupType) throws IOException {
        ResponseWriter writer = context.getResponseWriter();
    ...
    public void encodeTbody(FacesContext context, Table table, boolean dataOnly) throws IOException {
        this.encodeTbody(context, table, dataOnly, 0, table.getColumns().size(), null);
    }

    public void encodeTbody(FacesContext context, Table table, boolean dataOnly, int columnStart, int columnEnd, String tbodyId) throws IOException {
        ResponseWriter writer = context.getResponseWriter();
        ...
        if (!dataOnly) {
            ...
            writer.writeAttribute("class", Table.DATA_CLASS, null);
        }
        ...
        if (hasData) {
            ...
            //Empty message
            writer.startElement("tr", null);
            writer.writeAttribute("class", Table.EMPTY_MESSAGE_ROW_CLASS, null);
    ...
    protected void encodeRows(FacesContext context, Table table, int first, int last, int columnStart, int columnEnd) throws IOException {
        String clientId = table.getClientId(context);
    ...
    protected void encodeFrozenRows(FacesContext context, Table table) throws IOException {
        int frozenRows = table.getFrozenRows();
        if (frozenRows == 0) {
            return;
        }
    ...
    protected void encodeSummaryRow(FacesContext context, Table table, SummaryRow summaryRow) throws IOException {
    ...
    public boolean encodeRow(FacesContext context, Table table, String clientId, int rowIndex) throws IOException {
        return this.encodeRow(context, table, clientId, rowIndex, 0, table.getColumns().size());
    }

    public boolean encodeRow(FacesContext context, Table table, String clientId, int rowIndex, int columnStart, int columnEnd) throws IOException {
        ResponseWriter writer = context.getResponseWriter();
        ...
        String rowStyleClass = rowIndex % 2 == 0 ? Table.ROW_CLASS + " " + Table.EVEN_ROW_CLASS : Table.ROW_CLASS + " " + Table.ODD_ROW_CLASS;
        if (selectionEnabled && !table.isDisabledSelection()) {
            rowStyleClass = rowStyleClass + " " + Table.SELECTABLE_ROW_CLASS;
        }
        ...
        if (table.isEditingRow()) {
            rowStyleClass = rowStyleClass + " " + Table.EDITING_ROW_CLASS;
        }
        ...
        if (table.isExpandedRow()) {
            rowStyleClass = rowStyleClass + " " + Table.EXPANDED_ROW_CLASS;
        }
    ...
    protected void encodeCell(FacesContext context, Table table, UIColumn column, String clientId, boolean selected) throws IOException {
        if (!column.isRendered()) {
            return;
        }
        ...
        int priority = column.getPriority();
        String style = column.getStyle();
        String styleClass = selectionEnabled ? Table.SELECTION_COLUMN_CLASS : (column.getCellEditor() != null) ? Table.EDITABLE_COLUMN_CLASS : null;
        styleClass = (column.isSelectRow()) ? styleClass : (styleClass == null) ? Table.UNSELECTABLE_COLUMN_CLASS : styleClass + " " + Table.UNSELECTABLE_COLUMN_CLASS;
        styleClass = (column.isVisible()) ? styleClass : (styleClass == null) ? Table.HIDDEN_COLUMN_CLASS : styleClass + " " + Table.HIDDEN_COLUMN_CLASS;
    ...
    protected void encodeTFoot(FacesContext context, Table table) throws IOException {
        this.encodeTFoot(context, table, 0, table.getColumns().size(), null, null);
    }

    protected void encodeTFoot(FacesContext context, Table table, int columnStart, int columnEnd, String tfootId, String columnGroupType) throws IOException {
        ResponseWriter writer = context.getResponseWriter();
        List<UIColumn> columns = table.getColumns();
    ...
    protected void encodeFacet(FacesContext context, Table table, UIComponent facet, String styleClass) throws IOException {
        if (facet == null) {
            return;
        }
    ...
    protected void encodeStateHolder(FacesContext context, Table table, String id, String value) throws IOException {
        ResponseWriter writer = context.getResponseWriter();
    ...
    protected void encodeColumnSelection(FacesContext context, Table table, String clientId, UIColumn column, boolean selected) throws IOException {
        String selectionMode = column.getSelectionMode();
    ...
    protected void encodeRadio(FacesContext context, Table table, boolean checked, boolean disabled) throws IOException {
        ResponseWriter writer = context.getResponseWriter();
    ...
    protected void encodeCheckbox(FacesContext context, Table table, boolean checked, boolean disabled, String styleClass) throws IOException {
        ResponseWriter writer = context.getResponseWriter();
    ...
    protected void encodeNativeCheckbox(FacesContext context, Table table, boolean checked, boolean disabled) throws IOException {
        ResponseWriter writer = context.getResponseWriter();
    ...
    protected void encodeNativeRadio(FacesContext context, Table table, boolean checked, boolean disabled) throws IOException {
        ResponseWriter writer = context.getResponseWriter();
    ...
    protected void encodeSubTable(FacesContext context, Table table, SubTable subTable, int first, int last) throws IOException {
        for (int i = first; i < last; i++) {
            table.setRowIndex(i);
            if (!table.isRowAvailable()) {
                break;
    ...
    boolean isInSameGroup(FacesContext context, Table table, int currentRowIndex, ValueExpression groupByVE, ELContext eLContext) {

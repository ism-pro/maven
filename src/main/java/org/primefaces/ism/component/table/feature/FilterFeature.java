...
public class FilterFeature implements DataTableFeature {
    ...
    private boolean isFilterRequest(FacesContext context, Table table) {
    ...
    public void filter(FacesContext context, Table table, List<FilterMeta> filterMetadata, String globalFilterParam) {
        Map<String, String> params = context.getExternalContext().getRequestParameterMap();
    ...
    private Map<String, Object> populateFilterParameterMap(FacesContext context, Table table, List<FilterMeta> filterMetadata, String globalFilterParam) {
        Map<String, String> params = context.getExternalContext().getRequestParameterMap();
    ...
    public List<FilterMeta> populateFilterMetaData(FacesContext context, Table table) {
    ...
    private void populateFilterMetaDataWithoutColumnGroups(FacesContext context, Table table, List<FilterMeta> filterMetadata, Map<String, String> params, String separator) {
    ...
    private ColumnGroup getColumnGroup(Table table, String target) {

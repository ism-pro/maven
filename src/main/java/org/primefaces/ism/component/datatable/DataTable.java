...
import org.primefaces.ism.component.datatable.feature.*;
...
public class DataTable extends UIData implements org.primefaces.component.api.Widget, org.primefaces.component.api.RTLAware, javax.faces.component.behavior.ClientBehaviorHolder,org.primefaces.component.api.PrimeClientBehaviorHolder,org.primefaces.component.api.Pageable {
    ...
    public PaginationHelper getPagination() {
        return (PaginationHelper) getStateHelper().eval(PropertyKeys.pagination, null);
    }

    public void setPagination(PaginationHelper pagination) {
        getStateHelper().put(PropertyKeys.pagination, pagination);
    }
    ...
    public Object getValue() {
        super.getValue();
        Object value = this.getPagination().getModel();
        if (value != null) {
            return value;
        }
    ...
    @Override
    public int getPage() {
        //System.out.println("Get page Page = " + super.getPage() + " paginationPage = " + getPagination().getPage());
        int page = super.getPage();
        if (page == 0) {
            if (previousPage == getPagination().getPage()) {
                super.setFirst(getPagination().getPage() * getRows());
            }
        }
        previousPage = page;
        int newPage = super.getPage();
        getPagination().seekToPage(newPage);
        return page;
    }

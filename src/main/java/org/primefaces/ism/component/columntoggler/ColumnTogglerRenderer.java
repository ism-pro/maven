...
public class ColumnTogglerRenderer extends CoreRenderer {
    ...
    protected void encodeMarkup(FacesContext context, ColumnToggler columnToggler) throws IOException {
        ...
        writer.writeAttribute("id", clientId + "-link", "id");
        writer.writeAttribute("href", "#", "href");
        writer.writeAttribute("class", "ui-columntoggler-close", "class");
        writer.writeAttribute("aria-label", "Close", "aria-label");
        writer.endElement("a");
        
        writer.startElement("div", null);
        writer.writeAttribute("id", clientId+"-parent", "id");
        writer.endElement("div");
        */
        writer.endElement("div");
        /*
        <a href="#" class="ui-columntoggler-close" aria-label="Close"><span class="ui-icon ui-icon-close"></span></a>
         */
    }

...
PrimeFaces.widget.SelectManyMenu = PrimeFaces.widget.SelectListbox.extend({init: function (a) {
        this._super(a);
...
PrimeFaces.widget.SlideMenu = PrimeFaces.widget.Menu.extend({init: function (b) {
        this._super(b);
...
PrimeFaces.widget.TriStateCheckbox = PrimeFaces.widget.BaseWidget.extend({init: function (b) {
        this._super(b);
        this.input = $(this.jqId + "_input");
        this.box = this.jq.find(".ui-chkbox-box");
        this.icon = this.box.children(".ui-chkbox-icon");
...
PrimeFaces.widget.Chips = PrimeFaces.widget.BaseWidget.extend({init: function (a) {
        this._super(a);
        this.input = $(this.jqId + "_input");
        this.hinput = $(this.jqId + "_hinput");

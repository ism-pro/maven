...
(function ($, window, undefined) {
    ...
    $.widget('comiseo.daterangepicker', {
        ...
        options: {
            ...
            presetRanges: [
                {text: 'Aujourd\'hui', dateStart: function () {
                        return moment()
                    }, dateEnd: function () {
                        return moment()
                    }},
                {text: 'Hier', dateStart: function () {
                        return moment().subtract('days', 1)
                    }, dateEnd: function () {
                        return moment().subtract('days', 1)
                    }},
                {text: 'Depuis 7 jours', dateStart: function () {
                        return moment().subtract('days', 6)
                    }, dateEnd: function () {
                        return moment()
                    }},
                {text: 'Depuis (Lu-Di)', dateStart: function () {
                        return moment().subtract('days', 7).isoWeekday(1)
                    }, dateEnd: function () {
                        return moment().subtract('days', 7).isoWeekday(7)
                    }},
                {text: 'Mois au jour', dateStart: function () {
                        return moment().startOf('month')
                    }, dateEnd: function () {
                        return moment()
                    }},
                {text: 'Mois précédent', dateStart: function () {
                        return moment().subtract('month', 1).startOf('month')
                    }, dateEnd: function () {
                        return moment().subtract('month', 1).endOf('month')
                    }},
                {text: 'Année au jour', dateStart: function () {

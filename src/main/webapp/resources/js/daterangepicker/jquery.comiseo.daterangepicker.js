...
(function($, window, undefined) {
	...
	$.widget('comiseo.daterangepicker', {
		...
		options: {
			...
			presetRanges: [
				{text: 'Aujourd\'hui', dateStart: function() { return moment() }, dateEnd: function() { return moment() } },
				{text: 'Hier', dateStart: function() { return moment().subtract('days', 1) }, dateEnd: function() { return moment().subtract('days', 1) } },
				{text: 'Depuis 7 jours', dateStart: function() { return moment().subtract('days', 6) }, dateEnd: function() { return moment() } },
				{text: 'Depuis (Lu-Di)', dateStart: function() { return moment().subtract('days', 7).isoWeekday(1) }, dateEnd: function() { return moment().subtract('days', 7).isoWeekday(7) } },
				{text: 'Mois au jour', dateStart: function() { return moment().startOf('month') }, dateEnd: function() { return moment() } },
				{text: 'Mois précédent', dateStart: function() { return moment().subtract('month', 1).startOf('month') }, dateEnd: function() { return moment().subtract('month', 1).endOf('month') } },
				{text: 'Année au jour', dateStart: function() { return moment().startOf('year') }, dateEnd: function() { return moment() } }
			],
			initialText: 'Sélection période...', // placeholder text - shown when nothing is selected
			icon: 'ui-icon-triangle-1-s',
			applyButtonText: 'Ok', // use '' to get rid of the button
			clearButtonText: 'Effacer', // use '' to get rid of the button
			cancelButtonText: 'Annuler', // use '' to get rid of the button
